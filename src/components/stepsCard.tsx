...
function StepsCard({ stepNumber, heading, description }: StepsCardProps) {
  return (
    <Card className="w-full max-w-sm shadow-lg hover:shadow-xl transition-shadow rounded-xl bg-white dark:bg-gray-900 p-6 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-blue-100 to-orange-100 dark:from-gray-800 dark:to-transparent opacity-50"></div>
